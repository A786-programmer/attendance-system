                                    ...
                                    <tbody>
                                        <?php 
                                            ...
                                            while ($fetchAttendance = mysqli_fetch_assoc($attendance)) {
                                                $hoursWorked = '<p id="timer"></p>';
                                                if ($fetchAttendance['a_time_out'] != '00:00:00') {
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $hoursNeeded ?></td>
                                            <td><?= $fetchAttendance['a_timesheet'] ?></td>
                                        </tr>
                                        <?php 
                                                $sno++;
                                            }
...
<script>
    ...
    <?php
        ...
        if ($hasActiveCheckin) {
            $fetchAttendance = mysqli_fetch_assoc($checkToday);
            if ($fetchAttendance && $fetchAttendance['a_time_in'] && !$fetchAttendance['a_time_out']) {
                $startTimeJs = date("Y-m-d H:i:s", strtotime($today . ' ' . $fetchAttendance['a_time_in']));
